...
@Component({
  selector: 'app-toelettatura',
  templateUrl: './toelettatura.component.html',
  styleUrls: ['./toelettatura.component.css']
})
export class ToelettaturaComponent implements OnInit{
  ...
  onSubmit() {
    ...
    this.http.post<any>("http://localhost:3000/Toelettatura", this.appointmentForm.value)
      .subscribe(res => {
  ...
  getAppointments() {
    this.http.get('http://localhost:3000/Toelettatura')
      .subscribe(response => {
